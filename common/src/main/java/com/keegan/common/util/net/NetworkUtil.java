package com.keegan.common.util.net;
...
public class NetworkUtil {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            ContextUtil.getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            ContextUtil.getContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            XLog.d("isAvailableByPing errorMsg", result.errorMsg);
        }
        if (result.successMsg != null) {
            XLog.d("isAvailableByPing successMsg", result.successMsg);
        }
        return ret;
    }
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) ContextUtil.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
