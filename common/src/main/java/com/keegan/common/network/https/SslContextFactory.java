...
public class SslContextFactory {
    ...
    public static SSLSocketFactory getSSLSocketFactoryForTwoWay() {
        try {
            InputStream certificate = ContextUtil.getContext().getResources().openRawResource(R.raw.capk);
            ...
            clientKeyStore.load(ContextUtil.getContext().getResources().openRawResource(R.raw.cabks), TRUST_CA_PWD.toCharArray());
